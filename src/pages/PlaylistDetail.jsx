...
import {
  ...
  ArrowLeft,
  Plus,
  LoaderCircle, // 🚀 Cambiado Search por LoaderCircle
} from "lucide-react";
...
const PlaylistDetail = ({ onPlay }) => {
  ...
  // 🚀 ESTADO DE CARGA UNIFICADO: Ahora usa LoaderCircle con animación spin
  if (!playlist) {
    return (
  ...
  const firstTrackCover = playlist.tracks?.[0]?.album?.cover;
