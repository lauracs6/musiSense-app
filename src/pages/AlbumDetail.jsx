...
import { Loader2, Disc, ArrowLeft, Play, Music, Clock } from "lucide-react";
          ...
          <div className="w-full flex flex-col">
            ...
            <div className="mt-2 space-y-0.5">
              {tracks.map((track, index) => (
                <div
                  key={track.id}
                  className="grid grid-cols-[auto_1fr_1fr_auto] gap-4 items-center px-4 py-2.5 hover:bg-gray-900 rounded-lg transition-all group"
                >
                  ...
                  <div className="flex items-center gap-4 min-w-0">
                    <div className="flex flex-col truncate">
                      <span className="text-white text-lg transition-colors truncate">
                        {track.title}
                      </span>
